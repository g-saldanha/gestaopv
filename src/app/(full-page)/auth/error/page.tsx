    ...
    return (
        <div
            ...
            <div className="flex flex-column align-items-center justify-content-center">
                <img src="/pv/images/error/logo-error.svg" alt="Sakai logo" className="mb-5 w-6rem flex-shrink-0" />
                <div
                    style={{
                        borderRadius: '56px',
                        padding: '0.3rem',
                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center"
                        ...
                        <img src="/pv/images/error/asset-error.svg" alt="Error" className="mb-5" width="80%" />
                        <Button icon="pi pi-arrow-left" label="Ir para o Painel" text
                                onClick={() => router.push('/')} />
                    </div>
                </div>
            </div>
